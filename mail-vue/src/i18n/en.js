const en = {
    ...
    forwardAll: 'All',
    rules: 'Rules',
    ruleWhitelist: 'Whitelist (Only Forward)',
    ruleBlacklist: 'Blacklist (Do Not Forward)',
    ...
    forwardingRulesDesc: 'Set recipient-based whitelist (only forward) or blacklist (do not forward)',
    ruleEmailsInputDesc: 'Separate multiple email addresses with commas',
    aiSpamFilter: 'AI Spam Filter',
    aiSpamFilterDesc: 'Detect spam and skip TG forwarding',
    aiDailySummary: 'Daily AI Summary',
    aiDailySummaryDesc: 'Runs hourly, sends yesterday\'s summary at configured UTC hour',
    aiDailySummaryHour: 'Push Time (UTC)',
    aiPushMode: 'AI Push Mode',
    aiPushModeDesc: 'TG notification format',
    aiPushOriginal: 'Original (no processing)',
    aiPushConcise: 'Concise (extract core)',
    aiPushDetailed: 'Detailed (structured summary)',
