const zh = {
    ...
    forwardAll: '全部转发',
    rules: '规则转发',
    ruleWhitelist: '白名单（仅转发）',
    ruleBlacklist: '黑名单（不转发）',
    ...
    forwardingRulesDesc: '可按收件邮箱设置白名单（仅转发）或黑名单（不转发）',
    ruleEmailsInputDesc: '多个邮箱用, 分开',
    aiSpamFilter: 'AI 垃圾过滤',
    aiSpamFilterDesc: '识别后不转发到 TG',
    aiDailySummary: '每日 AI 摘要',
    aiDailySummaryDesc: '每小时检查，到达设定UTC时间后发送前一天邮件总结',
    aiDailySummaryHour: '推送时间 (UTC)',
    aiPushMode: 'AI 推送模式',
    aiPushModeDesc: 'TG 通知的格式',
    aiPushOriginal: '原始（不做处理）',
    aiPushConcise: '精简（提取核心内容）',
    aiPushDetailed: '详细（结构化摘要）',
